...
var gameDraw = {
    ...
    reanimateColors: () => {
        ...
        gameDraw.animatedColor.glitched = blinker ? gameDraw.color.blue : gameDraw.color.grey;
    ...
    getColor: (colorNumber) => {
        ...
        switch (colorNumber) {
            ...
            case "ocean":
            case "tetradecagon":
                return gameDraw.color.ocean;
            case "pentadecagon":
            case "toxic":
                return gameDraw.color.toxic;
            case "hexadecagon":
            case "pastelRed":
                return gameDraw.color.pastelred;
            case "sea":
            case "heptadecagon":
                return gameDraw.color.sea;
            case "octodecagon":
            case "darkGreen":
            case "octadecagon":
                return gameDraw.color.dgreen;
            case "enneadecagon":
            case "darkCyan":
            case "nonadecagon":
                return gameDraw.color.dcyan;
            case "icosagon":
                return gameDraw.color.icosagon;
            // teams
            case "3":
            case "neutral":
            case "yellow":
            ...
            case "wither":
            case "notwz":
                return gameDraw.color.wither;
            case "68":
            case "wither1":
            case "witherDarkPurple":
                return gameDraw.color.witherDarkPurple;
            case "69":
            case "wither2":
            case "witherPurple":
                return gameDraw.color.witherPurple;
            case "70":
            case "wither3":
            case "witherLightPurple":
                return gameDraw.color.witherLightPurple;
