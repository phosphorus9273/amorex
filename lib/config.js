...
global.tips = [[ // You can edit this!
        ...
        "Tip: You can enter the maze portal at certain level, there you will travel to the maze. Where rarer shapes spawn.",
        "Tip: Entering the pink portal will make your tank evolve into an Elite.",
        "Tip: You can restore your score if you died unfairly, just contact an in-game moderator or a developer.",
     /*   "Tip: You can create your own private server with the template in the link on the options menu.",
        ...
        "You can visit Amorex's reddit page in the links in the options menu, there you will have contact with other players."
    ], [
        ...
        "Fun Fact: Amorex has 10+ tank tiers, including Elites.",
        "Fun Fact: Wither bosses are a recreation of the ZK's on Notwz's old game Khorr.",
        "Fun Fact: There are 200+ bot names, all of them are writted manually."
    ]
];
